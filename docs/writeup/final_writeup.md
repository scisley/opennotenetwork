...
![Process diagram](./images/fact-check-process.png)
...
![Domain breakdown](./images/domain-classifier.png)
...
![Partisan tilt distribution](./images/partisan-tilt-distribution.png)
...
![Clarity distribution](./images/clarity-distribution.png)
...
![Tweet type distribution](./images/tweet-type-distribution.png)
...
![Context example tweet](./images/greg_abbot.png)
...
![Fact check diagram](./images/fact-check-diagram.png)
...
![Elon Musk's Cybertruck post](./images/elon-cybertruck.png)
...
![CPC vs CPM comparison](./images/cpc-cpm-comparison.png)
...
![Tweet age distribution](./images/tweet-age-distribution.png)
...
![Gunther's post](./images/gunther-post.png)
